...
import { removeItem, setPrio, toggleDone, useItems } from "@/lib/store";
import {
  PRIO_META,
  deptOf,
  filterItems,
        ...
        <div className="flex items-end justify-between px-4 pb-3 pt-6">
          <div>
            ...
            <p className="text-sm text-brand/50">
              {openCount > 0 ? `${openCount} פריטים ברשימה` : "הרשימה ריקה"}
            </p>
          </div>
          ...
          <div className="relative w-full max-w-sm animate-fadeIn rounded-3xl bg-white p-6 text-center shadow-sheet">
            ...
            <div className="mt-5 flex gap-2">
              ...
              <button
                ...
                className="flex-1 rounded-xl bg-red-600 px-4 py-2.5 font-medium text-white"
              >
                מחיקה
              </button>
            </div>
